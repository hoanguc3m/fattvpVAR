...
################################################################################################
{
  library(gtools)
  t_pred <- 24
  folderDir <- "/home/hoanguc3m/Downloads/WP11/G000/"
  ...
  G000 <- list(timeID_start = 561,
                     ...
                     SCRPS = array(NA, dim = c(t_pred,3,length_recursive))
  )
  ...
  for (i in c(1:length(filenames))){
    ...
    G000$SCRPS[,,i] <- out_recursive$forecast_err$SCRPS
  }
  ...
  G000$mSCRPS <- apply(G000$SCRPS, MARGIN = c(1,2), FUN = mean)



  ##########################################
  folderDir <- "/home/hoanguc3m/Downloads/WP11/G001/"
  filenames <- mixedsort(sort(list.files(path = folderDir)))
  ...
  for (i in c(1:length(filenames))){
    ...
    G001$SCRPS[,,i] <- out_recursive$forecast_err$SCRPS
  }
  ...
  G001$mSCRPS <- apply(G001$SCRPS, MARGIN = c(1,2), FUN = mean)

  ##########################################
  folderDir <- "/home/hoanguc3m/Downloads/WP11/G111/"
  filenames <- mixedsort(sort(list.files(path = folderDir)))
  ...
  for (i in c(1:length(filenames))){
    ...
    G111$SCRPS[,,i] <- out_recursive$forecast_err$SCRPS
  }
  ...
  G111$mSCRPS <- apply(G111$SCRPS, MARGIN = c(1,2), FUN = mean)

  ######################################
  folderDir <- "/home/hoanguc3m/Downloads/WP11/T000/"
  filenames <- mixedsort(sort(list.files(path = folderDir)))
  ...
  for (i in c(1:length(filenames))){
    ...
    T000$SCRPS[,,i] <- out_recursive$forecast_err$SCRPS
  }
  ...
  T000$mSCRPS <- apply(T000$SCRPS, MARGIN = c(1,2), FUN = mean)

  #########################################
  folderDir <- "/home/hoanguc3m/Downloads/WP11/T001/"
  filenames <- mixedsort(sort(list.files(path = folderDir)))
  ...
  for (i in c(1:length(filenames))){
    ...
    T001$SCRPS[,,i] <- out_recursive$forecast_err$SCRPS
  }
  ...
  T001$mSCRPS <- apply(T001$SCRPS, MARGIN = c(1,2), FUN = mean)

  ###############################################
  folderDir <- "/home/hoanguc3m/Downloads/WP11/T111/"
  filenames <- mixedsort(sort(list.files(path = folderDir)))
  ...
  for (i in c(1:length(filenames))){
    ...
    T111$SCRPS[,,i] <- out_recursive$forecast_err$SCRPS
  }
  ...
  T111$mSCRPS <- apply(T111$SCRPS, MARGIN = c(1,2), FUN = mean)
...
################################################
{
  ...
  load("/home/hoanguc3m/Downloads/WP11/G000/Recursive_Gaussian_M000_T562.RData")
...

{
  ...
  pdf(file='img/cumLogBF6-G1-G0.pdf', width = 8, height = 9)
...

{
  ...
  pdf(file='img/cumLogBF6-S1-G1.pdf', width = 8, height = 9)
  #pdf(file='img/diff_log.pdf', width = 11, height = 6)
